  ...
  describe('Check static resource creation', () => {
    ...
    test
      ...
      .it('should create foo static resource in the default output directory', (ctx) => {
        ...
        assert.fileContent(path.join(process.cwd(), 'foo/.gitkeep'), 'This file can be deleted');
      });
    ...
    test
      ...
      .it('should create foo resource with a targetpath set', (ctx) => {
        assert.file([path.join('resourcesjs', 'srjs.resource-meta.xml'), path.join('resourcesjs', 'srjs.js')]);
      });
    ...
    test
      ...
      .it('should create foo static resource in custom folder name that has a space in it', (ctx) => {
        ...
        assert.fileContent(path.join('staticresource create', 'foo', '.gitkeep'), 'This file can be deleted');
      });
  });
