...
describe('Lightning app creation tests:', () => {
  describe('Check lightning app creation', () => {
    test
      ...
      .it('should create lightning app foo using DefaultLightningApp template and aura output directory', (ctx) => {
    ...
    test
      ...
      .withProject()
      .stdout()
      .command(['force:lightning:app:create', '--appname', 'foo', '--outputdir', path.join('aura', 'testing')])
