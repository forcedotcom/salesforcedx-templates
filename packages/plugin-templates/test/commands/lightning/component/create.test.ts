...
describe('Lightning component creation tests:', () => {
  ...
  describe('Check lightning web components creation', () => {
    test
      .stdout()
      .command(['force:lightning:component:create', '--componentname', 'FooBar', '--outputdir', 'lwc', '--type', 'lwc'])
      .it('should force first letter of component name to lowercase', (ctx) => {
        ...
        assert.fileContent(jsPath, 'export default class FooBar extends LightningElement {}');
      });
